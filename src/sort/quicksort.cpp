...
auto partition(std::vector<int>* source, size_t start_idx, size_t end_idx) -> size_t {
...
void quick_sort_helper(std::vector<int> *source, size_t start_idx, size_t end_idx) {
